                ...
                <table className='divide-y divide-gray-200'>
                  ...
                  <tbody class='bg-white divide-y divide-gray-200'>
                    {getPaginatedData().map((d, idx) => (
                      <tr
                        key={d.email}
                        class='whitespace-nowrap transition duration-800 ease-in-out hover:bg-indigo-500 transform hover:-translate-y-1 hover:scale-110'
                      >
