                ...
                steps.map((step, index) => {
                    return (
                        <div key={step.icon} className="relative z-10">
                            ...
                            <div className={`timeline-container ${index % 2 ? "" : "timeline-container-left"}`}>
                                <div className={`timeline-pointer ${index % 2 ? "" : "timeline-pointer-left"}`} aria-hidden="true"> </div>
                                <div className="bg-indigo-100 p-6 rounded-md shadow-md">
                                    <span className="font-bold text-indigo-600 text-sm tracking-wide">Aug 2020</span>
